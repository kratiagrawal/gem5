...
# REF CMDS
perlbench.cmd = [perlbench.executable] + ['-I./lib', 'checkspam.pl',
        '2500', '5', '25', '11', '150', '1', '1', '1', '1']
#perlbench.cmd = [perlbench.executable] + ['-I./lib', 'diffmail.pl',
#'4', '800', '10', '17', '19', '300']
#perlbench.cmd = [perlbench.executable] + ['-I./lib', 'splitmail.pl',
#'1600', '12', '26', '16', '4500']
...
#'--num', '45000', '--sd', '200', '--seed', '0', 'bombesin.hmm']
# REF CMDS
hmmer.cmd = [hmmer.executable] + ['nph3.hmm', 'swiss41']
#hmmer.cmd = [hmmer.executable] + ['--fixed', '0', '--mean', '500',
#'--num', '500000', '--sd', '350', '--seed', '0', 'retro.hmm']
...
# REF CMDS [UPDATE 10/2/2015]: Sparsh Mittal has pointed out the correct
#input for libquantum should be 1397 and 8, not 1297 and 8. Thanks!
